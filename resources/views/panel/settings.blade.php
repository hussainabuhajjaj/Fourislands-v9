@extends('panel.layout.master' , ['title' => 'Settings'])
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="kt_tabs_5_1" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="site_name"
                                           value="{{ getSetting('site_name') }}"
                                           class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('site name')">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">@lang('site logo')</label>
                                    <div></div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" accept="image/*" id="imgload"
                                               name="site_logo">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="site_description" class="form-control" aria-describedby="emailHelp"
                                              placeholder="@lang('site description')">{{ getSetting('site_description') }}</textarea>
                                </div>
                                    <div class="form-group">

                                    <label>@lang('Ceo Speech')</label>
                                    <textarea name="ceo_speech" class="form-control" aria-describedby="emailHelp"
                                              placeholder="@lang('site description')">{{ getSetting('ceo_speech') }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="site_footer_description" class="form-control"
                                              aria-describedby="emailHelp"
                                              placeholder="@lang('footer description')">{{ getSetting('site_footer_description') }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>@lang('keywords')</label>
                                    <input id="kt_tagify_1" name='site_tags' placeholder='@lang('keywords') ...'
                                           value='{{ getSetting('site_tags') }}'>
                            ...
                            <div class="tab-pane" id="kt_tabs_5_2" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email"
                                           value="{{ getSetting('email') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('email')">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone"
                                           value="{{ getSetting('phone') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('phone')">
                                </div>
                                <div class="form-group">
                                    <label>@lang('address')</label>
                                    <input type="text" name="address"
                                           value="{{ getSetting('address') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('address')">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="kt_tabs_5_3" role="tabpanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook"
                                           value="{{ getSetting('facebook') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('facebook')">
                                </div>
                                <div class="form-group">
                                    <label>@lang('twitter')</label>
                                    <input type="text" name="twitter"
                                           value="{{ getSetting('twitter') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('twitter')">
                                </div>
                                <div class="form-group">
                                    <label>@lang('linkedin')</label>
                                    <input type="text" name="linkedIn"
                                           value="{{ getSetting('linkedIn') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('linkedin')">
                                </div>
                                <div class="form-group">
                                    <label>@lang('whatsapp')</label>
                                    <input type="text" name="whatsapp"
                                           value="{{ getSetting('whatsapp') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('whatsapp')">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="instagram"
                                           value="{{ getSetting('instagram') }}"
                                           class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('instagram')">
                                </div>
                                <div class="form-group">
                                    <label>@lang('youtube')</label>
                                    <input type="text" name="youtube"
                                           value="{{ getSetting('youtube') }}" class="form-control"
                                           aria-describedby="emailHelp" placeholder="@lang('youtube')">
                                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__body ">
                        ...
                        <input type="hidden" id="startLat" name="latitude" value="{{ \App\Models\Setting::getSetting('latitude')->value }}">
                        <input type="hidden" id="startLon" name="longitude" value="{{ \App\Models\Setting::getSetting('longitude')->value }}">
