            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('panel.services.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
@push('js')
    ...
    <script>
        ...
        window.data_url = '{{url('panel/services/datatable')}}';
        ...
        window.columns = [
            ...
            },
            {
                ...
                width: 100,
                template: function (data) {
                    var editUrl = "{{ url('panel/services/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/services/') }}/" + data.id;
                    return `
