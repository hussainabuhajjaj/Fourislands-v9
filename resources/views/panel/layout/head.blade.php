<head>
	...
	<link href="{{ asset('panelAssets/css/skins/header/base/light.min.css') }}" rel="stylesheet" type="text/css"/>
	<link href="{{ asset('panelAssets/css/skins/header/menu/light.min.css') }}" rel="stylesheet" type="text/css"/>
	<link href="{{ asset('panelAssets/css/skins/brand/dark.min.css') }}" rel="stylesheet" type="text/css"/>
	<link href="{{ asset('panelAssets/css/skins/aside/dark.min.css') }}" rel="stylesheet" type="text/css"/>
	<link href="{{ asset('panelAssets/css/sweetalert2.css') }}" rel="stylesheet" type="text/css" />
