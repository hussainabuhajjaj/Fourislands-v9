@extends('panel.layout.master' , ['title' => 'Inbox'])
						...
						<div class="dropdown">
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="contacts/` + data.id + `/show"><i class="fa fa-eye"></i> Open Message</a>
                                    <a class="dropdown-item" href="contacts/`+ data.id +`/show-replay"><i class="fa fa-reply"></i> Show Replies</a>
                                    <a class="dropdown-item delete"  data-url="contacts/` + data.id + `" href="#" id="deleteContact"><i class="fa fa-trash"></i>Delete Message </a>
                                </div>
						</div>`;
                },
            }
