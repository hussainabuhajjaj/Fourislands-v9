@extends('panel.layout.master' , ['title' => 'Show Inbox' ])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Show Inbox</h3>
            </div>
        </div>
    </div>
@endsection
                    ...
                    <div class="row row-no-padding row-col-separator-xl">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-4">
                            ...
                            <div class="kt-widget1">
                                ...
                                <div class="kt-widget1__item">
                                    <div class="kt-widget1__info">
                                        <h3 class="kt-widget1__title">Subject</h3>
                                        <span class="kt-widget1__desc">{{ $contact->subject }}</span>
                                    </div>
                                </div>
                                <div class="kt-widget1__item">
                                    <div class="kt-widget1__info">
                                        <h3 class="kt-widget1__title">Message</h3>
