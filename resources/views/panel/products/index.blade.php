            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('panel.products.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
@push('js')
    ...
    <script>
        ...
        window.data_url = '{{url('panel/products/datatable')}}';
        ...
        window.columns = [
            ...
            },
            {
                ...
                width: 100,
                template: function (data) {
                    var editUrl = "{{ url('panel/products/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/products/') }}/" + data.id;
                    return `
