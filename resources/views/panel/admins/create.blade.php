                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        <input class="form-control m-input" type="text" name="name"
                               value="{{ isset($item) ? $item->name : "" }}" required placeholder="@lang('translate.name')">
                    </div>
                    <div class="form-group">
                        <label>@lang('translate.email')</label>
                        <input class="form-control m-input" type="email" required name="email"
                               placeholder="@lang('translate.email')" value="{{ isset($item) ? $item->email : "" }}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control m-input" type="password" {{ isset($item) ? '' : "required" }}  name="password_confirmation"
                               placeholder="@lang('translate.confirm_password')">
                    </div>
                </div>
            </div>
        </div>
